...
#define EXPERIMENT_VARIANT_V1 3
#define EXPERIMENT_VARIANT_V2 4

#ifndef EXPERIMENT_VARIANT  
#define EXPERIMENT_VARIANT EXPERIMENT_VARIANT_V1
#endif
...
#define EXPERIMENT_RFRAG_ACK_IDLE_ENABLED     0
#define EXPERIMENT_APP_RETRY_ENABLED          0
#elif EXPERIMENT_VARIANT == EXPERIMENT_VARIANT_V1
#define EXPERIMENT_VARIANT_NAME              "V1_RFRAG_FIRST_FINAL_ACK"
#define EXPERIMENT_RFRAG_ENABLED              1
#define EXPERIMENT_RFRAG_ACK_FIRST            1
#define EXPERIMENT_RFRAG_ACK_IDLE_ENABLED     0
#define EXPERIMENT_APP_RETRY_ENABLED          0
#elif EXPERIMENT_VARIANT == EXPERIMENT_VARIANT_V2
#define EXPERIMENT_VARIANT_NAME              "V2_RFRAG_FINAL_ACK_APP_RETRY"
#define EXPERIMENT_RFRAG_ENABLED              1
#define EXPERIMENT_RFRAG_ACK_FIRST            0
#define EXPERIMENT_RFRAG_ACK_IDLE_ENABLED     0
#define EXPERIMENT_APP_RETRY_ENABLED          1
#else
#error "EXPERIMENT_VARIANT must be 1, 2, 3, 4"
#endif
...
#if EXPERIMENT_VARIANT == EXPERIMENT_VARIANT_V2
/* B2' effectue au plus une nouvelle tentative applicative complète. */
#define APP_CONF_MAX_RETRIES 1
#else
...
/* Invariants propres à B2' : même RFRAG que B2, retry applicatif seulement. */
#if EXPERIMENT_VARIANT == EXPERIMENT_VARIANT_B2_PRIME
#if !EXPERIMENT_RFRAG_ENABLED || !EXPERIMENT_APP_RETRY_ENABLED
#error "B2' requires both RFRAG and application-level retry"
#endif
#if EXPERIMENT_RFRAG_ACK_FIRST || EXPERIMENT_RFRAG_ACK_IDLE_ENABLED
#error "V1 must be B2 + initial ACK only"
#endif
#endif

/* V2 historique reste RFC4944 + retry applicatif, sans RFRAG. */
#if EXPERIMENT_VARIANT == EXPERIMENT_VARIANT_V5 && EXPERIMENT_RFRAG_ENABLED
#error "V2 must be B2 + application-level retry only"
#endif
